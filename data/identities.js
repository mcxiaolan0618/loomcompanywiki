const IDENTITIES_INDEX = [
    ...
    },
    {
        ...
        skillBottom: { physics: '突刺', sin: '暴食' },
        combatPassive:  { sin: '怠惰', way: '持有', need: '3' },
        supportPassive: { sin: '怠惰', way: '持有', need: '3' }
    },
    {
        id: 'LCR员工-爱德蒙',
        rarity: 1,
        ...
        skillTop:    { physics: '突刺', sin: '暴怒' },
        skillMiddle: { physics: '突刺', sin: '暴食' },
        skillBottom: { physics: '突刺', sin: '嫉妒' },
        combatPassive:  { sin: '暴食', way: '持有', need: '3' },
        supportPassive: { sin: '暴食', way: '持有', need: '6' }
    },
    {
        id: 'LCR员工-伍符',
        rarity: 1,
